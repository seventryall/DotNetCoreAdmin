layui.use('element', function () {
    ...
    var tabs = {
        add: function (id, name, url) {
           ...
           // setIframeHeight($(iframeHtml));

            //需要自己处理添加iframe到dom？
            this.change(id);
           // var h = $(window).height() - 100;
           // $("iframe")[1].height = $("iframe")[1].document.body.scrollHeight;//h+"px";
            //FrameWH($(iframeHtml));
            ...
            //var height2 = temph > 400 ? temph : height;//给与一个界限
            if (!tabExist) {
               // iframe.height = height2 + "px";
               // alert(height2);
            ...
            //    iframe.height = iframeWin.document.documentElement.scrollHeight || iframeWin.contentDocument.body.scrollHeight;
            //}
            //iframe.height = iframe.contentWindow.document.documentElement.scrollHeight;
           
            //$(iframeHtml).on("load", function () {
            //    var temph = $(this)[0].contentDocument.body.scrollHeight;
            //    var height = temph > 400 ? temph : height;//给与一个界限
            //    $iframe.css("height", height + "px");
            //    //$iframe.height = temph > 400 ? temph : height;//给与一个界限
            //});
            //$(iframeHtml)[0].onload = function () {
            //    alert();
            //};
        },
